package com.rays.p10.common.mail;
...
import com.rays.p10.common.message.MessageDTO;
import com.rays.p10.common.message.MessageServiceInt;
...
public class EmailServiceImpl {
	...
	public void send(EmailDTO dto, UserContext ctx) {
		...
		if (dto.getMessageCode() != null) {
			...
			//dto.setBody(messageDTO.getHtml());
